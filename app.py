            ...
            with st.spinner("Processing..."):
                ...
                if sentiment.lower() == "negative":
                    mail_status = send_email(
                        ...
                        "Thanks for your feedback. Here’s a special offer for you - 10 percent discount on your next bill. Incase of any service issues we will be working on it proactively...."
                    )
                else:
                    mail_status = send_email(
                        email,
